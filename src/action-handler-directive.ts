...
customElements.define('action-handler-datetime-picker-card', ActionHandler);

const getActionHandler = (): ActionHandler => {
  const body = document.body;
  if (body.querySelector('action-handler-datetime-picker-card')) {
    return body.querySelector('action-handler-datetime-picker-card') as ActionHandler;
  }

  const actionhandler = document.createElement('action-handler-datetime-picker-card');
